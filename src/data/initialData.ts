...
export const initialMaliRegions: MaliRegion[] = [
  ...
  },
  {
    id: 'gao',
    name: {
      ar: 'غاو (عاصمة إمبراطورية الصنغاي وضريح اسكيا)',
      fr: 'Gao (Cité des Askia)',
      en: 'Gao (Cradle of Askia Empire)',
    },
    description: {
      ar: 'موطن الملك اسكيا العظيم والضريح التاريخي، تشهد احتياجاً كبيراً لمشاريع المياه النظيفة والمراكز الصحية.',
      fr: 'Berceau d’Askia le Grand et du célèbre Tombeau classé à l’UNESCO, zone prioritaire en santé et eau.',
      en: 'Heartland of King Askia the Great and the UNESCO Tomb of Askia, priority for solar water and health.',
    },
    historicalContext: {
...
export const initialCampaigns: Campaign[] = [
  {
    id: 'camp-water-gao',
    title: {
      ar: 'حملة سقيا الأمل: 10 آبار شمسية في أرياف غاو وتمبكتو',
      fr: 'Campagne Eau & Vie : 10 Forages Solaires à Gao et Tombouctou',
      en: 'Clean Water Hope Campaign: 10 Solar Wells in Gao & Timbuktu',
    },
    description: {
      ar: 'حفر وتجهيز 10 محطات مياه ارتوازية تعمل بالطاقة الشمسية مع خزانات علوية ونقاط توزيع لتوفير مياه شرب نقية لأكثر من 15,000 إنسان.',
      fr: 'Construction et équipement de 10 forages solaires avec châteaux d’eau pour fournir une eau pure à plus de 15 000 habitants.',
      en: 'Drilling and equipping 10 solar-powered deep water stations with distribution points to serve over 15,000 villagers.',
    },
    targetAmount: 50000,
    raisedAmount: 32450,
    currency: 'USD',
  ...
  {
    id: 'camp-schools-sahel',
    title: {
      ar: 'حملة براعم اسكيا: تأهيل 12 مدرسة وتأمين الحقائب المدرسية',
      fr: 'Campagne Éducation d’Avenir : Rénovation de 12 Écoles au Sahel',
      en: 'Askia Education Drive: Rehabilitating 12 Classrooms & Supplies',
    },
    description: {
      ar: 'إعادة بناء الفصول الدراسية الطينية المتضررة وتزويدها بالمقاعد والألواح الشمسية وتوزيع 3,000 حقيبة مدرسية متكاملة للطلاب.',
      fr: 'Réhabilitation de salles de classe dégradées, mobilier scolaire et distribution de 3 000 kits scolaires complets.',
      en: 'Rebuilding degraded rural classrooms, installing solar lighting, desks, and distributing 3,000 educational kits.',
    },
    targetAmount: 35000,
    raisedAmount: 21800,
    currency: 'USD',
  ...
  },
  {
    ...
    title: {
      ar: 'حملة النبض الآمن: عيادات أمومة ورعاية صحية للمناطق النائية',
      fr: 'Campagne Santé Maternelle : Équipement de 5 Maternités Rurales',
      en: 'Safe Pulse Campaign: Equipping 5 Rural Maternity Health Centers',
    },
    description: {
      ar: 'تجهيز مراكز صحية ريفية بمعدات التوليد وأجهزة الإنعاش وتوفير قوافل طبية لعلاج الأطفال والنساء الحوامل في بوركينا فاسو والنيجر.',
      fr: 'Fourniture de kits d’accouchement d’urgence, tables d’auscultation et caravanes médicales pédiatriques.',
      en: 'Supplying emergency obstetrics equipment, infant care beds, and mobile medical convoys across border villages.',
    },
    targetAmount: 40000,
    raisedAmount: 18900,
    currency: 'USD',
  ...
  {
    id: 'camp-relief-sahel',
    title: {
      ar: 'حملة إطعام الساحل: سلال غذائية متكاملة للأسر المتضررة',
      fr: 'Campagne Secours Alimentaire : Colis Vivres pour 2 500 Foyers',
      en: 'Sahel Food Relief: Essential Food Parcels for 2,500 Families',
    },
    description: {
      ar: 'توزيع سلال غذائية تحتوي على الحبوب الأساسية (الأرز، الدخن، الزيت، السكر) للأسر المتعففة والنازحة جراء الجفاف.',
      fr: 'Distribution de vivres de base (riz, mil, huile, sucre) aux familles vulnérables et déplacées.',
      en: 'Delivering core staples (rice, millet, cooking oil, sugar, and flour) to displaced rural communities.',
    },
    targetAmount: 30000,
    raisedAmount: 28500,
    currency: 'USD',
...
export const initialGallery: GalleryItem[] = [
  {
    ...
    type: 'image',
    url: 'https://images.unsplash.com/photo-1541252260730-0412e8e2108e?auto=format&fit=crop&w=1000&q=80',
    thumbnailUrl: 'https://images.unsplash.com/photo-1541252260730-0412e8e2108e?auto=format&fit=crop&w=400&q=80',
    sector: 'water',
    country: 'mali',
    location: 'تمبكتو',
  },
  ...
  },
  {
    id: 'gal-4',
    title: {
      ar: 'توزيع الطرود الإغاثية للأسر المتضررة في تيلابيري',
